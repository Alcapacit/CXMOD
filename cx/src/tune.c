...
/* IPv6 tuning */
{"net.ipv6.conf.all.disable_ipv6",      {"0",              "0",               "0",             "0",             "0"           }},
{"net.ipv6.conf.all.use_tempaddr",      {"2",              "2",               "2",             "2",             "2"           }},
{"net.ipv6.conf.default.use_tempaddr",  {"2",              "2",               "2",             "2",             "2"           }},
{"net.ipv6.conf.all.accept_ra",         {"1",              "1",               "1",             "1",             "0"           }},
{"net.ipv6.conf.all.accept_redirects",  {"0",              "0",               "0",             "0",             "0"           }},
{"net.ipv6.neigh.default.gc_thresh1",   {"1024",           "2048",            "512",           "2048",          "512"         }},
{"net.ipv6.neigh.default.gc_thresh2",   {"4096",           "8192",            "2048",          "8192",          "2048"        }},
{"net.ipv6.neigh.default.gc_thresh3",   {"8192",           "16384",           "4096",          "16384",         "4096"        }},
...
int tune_auto_bdp(bool dry_run)
{
    ...
    if (fastest == 0) {
        cxmod_warn("Could not detect interface speed. Use: cx tune --bdp <Mbit> <ms>");
        return CXMOD_ERR;
    }
    ...
    double rtt_ms = 20.0;
    printf("  Assumed RTT: %.0f ms  (override with: cx tune --bdp %u <your_rtt_ms>)\n\n",
           rtt_ms, fastest);
